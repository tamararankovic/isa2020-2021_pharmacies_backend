...
public class NewDermatologistInPharmacyDTO {
	...
	public NewDermatologistInPharmacyDTO(long dermatologistId, boolean monday, boolean tuesday, boolean wednesday,
			boolean thursday, boolean friday, boolean saturday, boolean sunday, LocalDateTime mondayStart,
			LocalDateTime mondayEnd, LocalDateTime tuesdayStart, LocalDateTime tuesdayEnd, LocalDateTime wednesdayStart,
			LocalDateTime wednesdayEnd, LocalDateTime thursdayStart, LocalDateTime thursdayEnd, LocalDateTime fridayStart,
			LocalDateTime fridayEnd, LocalDateTime saturdayStart, LocalDateTime saturdayEnd, LocalDateTime sundayStart,
			LocalDateTime sundayEnd) {
		super();
	...
	public void setSaturday(boolean satudray) {
		this.saturday = satudray;
	}
	...
	public void setSaturdayEnd(LocalDateTime satudrayEnd) {
		this.saturdayEnd = satudrayEnd;
	}
