...
insert into users(id, name, surname, email, password, role, active, loged) values (7, 'Milijana', 'Djordjevic', 'rankovictamaraa+1@gmail.com', '1234', 0, TRUE, TRUE);
...
insert into dermatologist_appointment(id, default_duration_in_minutes, duration_in_minutes, patient_was_present, price, scheduled, start_date_time, dermatologist_id, patient_id, pharmacy_id, done) values (1, 30, 30, '1', 2000, '1', '2021-02-08 08:30:00.000000', 1, 1, 1, '1');
...
insert into dermatologist_appointment(id, default_duration_in_minutes, duration_in_minutes, patient_was_present, price, scheduled, start_date_time, dermatologist_id, patient_id, pharmacy_id, done) values (4, 30, 30, '0', 2000, '1', '2021-02-25 08:30:00.000000', 1, 3, 2, '0');
insert into dermatologist_appointment(id, default_duration_in_minutes, duration_in_minutes, patient_was_present, price, scheduled, start_date_time, dermatologist_id, patient_id, pharmacy_id, done) values (5, 30, 30, '1', 2000, '1', '2021-02-08 09:30:00.000000', 1, 3, 1, '1');
insert into dermatologist_appointment(id, default_duration_in_minutes, duration_in_minutes, patient_was_present, price, scheduled, start_date_time, dermatologist_id, patient_id, pharmacy_id, done) values (6, 30, 30, '0', 2000, '1', '2021-02-08 15:35:00.000000', 1, 3, 1, '0');
alter sequence dermatologist_appointment_id_seq restart with 7;
